...
abstract class TweetSet extends TweetSetInterface {
  ...
  // a helper method for mostRetweeted
  def mostRetweetedIter(mostPopularTweet: Tweet): Tweet
...
class Empty extends TweetSet {
  ...
  def mostRetweetedIter(mostPopularTweet: Tweet): Tweet = mostPopularTweet
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweetedIter(mostPopularTweet: Tweet): Tweet = {
    if (elem.retweets > mostPopularTweet.retweets) this.remove(elem).mostRetweetedIter(elem)
    else this.remove(elem).mostRetweetedIter(mostPopularTweet)
  }

  def mostRetweeted: Tweet = this.mostRetweetedIter(elem)
